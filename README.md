...
The experiments use synthetic data and fact rows as privacy units. A real deployment may use distinct subject identifiers instead, together with further privacy algorithms such as k-anonymity.
